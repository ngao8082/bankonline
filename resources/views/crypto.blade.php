...
@section('withdrawcontent')
                ...
                <p>Sell your Crpto cash securely from our online banking system.</p>
            </div>
            <div class="row mt-5">
                    ...
                    <div class="row">
                        <div class="col-md-6 justify-content-md-center">
                            <div class="text-center shadow-sm p-3 mb-5 w-75 bg-body rounded">
                                ...
                                <h5 class="card-title fw-bolder">Crypto Balance</h5>
                                <p class="card-text">ETH 0.00</p>
                                <p class="card-text">Ksh0.00</p>
                                <a href="#" class="btn btn-info btn-sm me-4 ">Sell</a>
                                <a href="#" class="btn btn-info btn-sm ms-4 me-1">Buy</a>
                            </div>
                        </div>
                        <div class="col-md-6 ">
                            <form class="row g-3 shadow p-3 mb-5 bg-body rounded">
                                <div class="col-md-8">
                                    <label for="validationDefault01" class="form-label fw-bolder">Account Number</label>
                                    <input type="text" class="form-control" id="validationDefault01" placeholder="Enter your Account number"
                                        required>
                                </div>
                                <div class="col-md-8">
                                    <label for="validationDefault02" class="form-label fw-bolder">Amount To Sell</label>
                                    <input type="text" class="form-control" id="validationDefault02" placeholder="amount to Sell"
                                        required>
                                </div>
                                <div class="col-md-8">
                                <button type="submit" class="btn btn-block btn-info btn-sm">Sell</button>
                                </div>
                            </form>
                        </div>
                    </div>
