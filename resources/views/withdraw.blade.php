...
@section('withdrawcontent')
                ...
                <h1 class="fw-bolder">Withdraw Cash
                </h1>
                <div class="col-md-12">
                ...
                <p>Withdraw your cash securely from our online banking system.</p>
            </div>
            <div class="row mt-5">
                        ...
                        <div class="col-md-6 ">
                            <form class="row g-3 shadow p-3 mb-5 bg-body rounded">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" class="form-control" id="validationDefault01" placeholder="Enter your Account numnber"
                                        required>
                                </div>
                                <div class="col-md-8">
                                    <label for="validationDefault02" class="form-label fw-bolder">Amount To withdraw</label>
                                    <input type="text" class="form-control" id="validationDefault02" placeholder="amount to withdraw"
                                        required>
                                </div>
                                <div class="col-md-8">
                                <button type="submit" class="btn btn-block btn-info btn-sm">Withdraw</button>
                                </div>
                            </form>
                        </div>
                    </div>
