...
{{--                    </div>--}}
{{--                    <div class="d-flex justify-content-around align-items-center mb-4">--}}
{{--                        <button type="submit" class="btn btn-primary btn-sm block">Sign in</button>--}}
{{--                    </div>--}}
...
{{--                    <a class="btn btn-primary btn-lg block" style="background-color: #3b5998" href="#!"--}}
{{--                       role="button">--}}
{{--                        <i class="fa fa-facebook me-2"></i>Continue with Facebook--}}
{{--                    </a>--}}
{{--                    <a class="btn btn-primary btn-lg block" style="background-color: #55acee" href="#!"--}}
{{--                       role="button">--}}
        ...
        <div class="card-body">
            ...
            <div class="card">
                <div class="card-header text-center ">
                    <h3 class="fw-bolder">{{ __('Two factor authentication') }}</h3>
                </div>
                    ...
                    @endif
                            ...
                            @if (session('status') == 'two-factor-authentication-enabled')
                                <div class="mb-4 font-medium text-sm">
                                    you have now enabled two factor authentication you can use your phone scanner to scan the qr code below
                                    {!!auth()->user()->twoFactorQrCodeSvg()!!};
                                    <p>please store this recovery code in secure manner</p>
